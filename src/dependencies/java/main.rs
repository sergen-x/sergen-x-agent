...
pub async fn download_and_install(
    ...
    distribution
        .download_version(version.as_str(), system, variant.as_str())
        .await?;
    Ok(())
}
...
pub async fn install(
    ...
    let distribution_object: Arc<dyn JavaDistribution + Send> =
    ...
    match download_and_install(version, system, variant, distribution_object)
        .await
    {
